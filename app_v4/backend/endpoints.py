...
async def create_edition(
    ...
    # Используем функцию из utils.py для добавления издания
    utils.add_edition(db, edition_data)
...
async def create_editorial(
    ...
    # Используем функцию из utils.py для добавления редакции
    utils.add_editorial(db, editorial_data)
...
async def delete_edition(
    ...
    try:
        # Используем функцию из utils.py для удаления издания
        deleted_edition = utils.delete_edition(db, title=title)
        if deleted_edition is None:
...
async def delete_editorial(
    ...
    try:
        # Используем функцию из utils.py для удаления редакции
        deleted_editorial = utils.delete_editorial(db, edition_title=edition_title)
        if deleted_editorial is None:
